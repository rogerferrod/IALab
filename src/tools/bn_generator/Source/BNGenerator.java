//================================================================
//     Copyright (c) 2005, Escola Politécnica-USP
//                     All Rights Reserved
//================================================================
//
// NAME : BNGenerator
    ...
    void ckeckingCycle(int nGra,int nIterati,int maxVal,String te,String fo,String baseFileNam,int maxInducedWidt) throws Exception{
        ...
        for (semente=1;semente<10000;semente++){
            ...
            if  (iwDistribution[3]<900)  {
                System.out.println("A semente geradora de ciclo é:"+semente);
                outputFile.println("A semente procurada geradora de ciclo é:"+semente);
