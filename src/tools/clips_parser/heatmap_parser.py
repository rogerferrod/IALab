"""
A simple script that given CLIPS output prints a heatmap for the given map in the clips output.
"""
...
if __name__ == "__main__":
    ...
    # python3 heatmap_parser.py -f ./input/out0.txt  -t ./input/heat0.txt -o ./output/
