...
public class Testing {
    ...
    public static void main(String[] args) {
        ...
        RandomVariable[] query = Arrays.stream(getRainWindNet().getVariablesInTopologicalOrder().toArray(new RandomVariable[0]))
        ...
        pf = new ParticleFiltering(n, Testing.getRainWindNet());
    ...
    private static DynamicBayesianNetwork getRainWindNet() {
        FiniteNode prior_rain_tm1 = new FullCPTNode(ExampleRV.RAIN_tm1_RV,
                new double[]{0.5, 0.5});
        FiniteNode prior_wind_tm1 = new FullCPTNode(Testing.WIND_tm1_RV,
                new double[]{0.5, 0.5});
        ...
        FiniteNode rain_tm1 = new FullCPTNode(ExampleRV.RAIN_tm1_RV,
                new double[]{0.5, 0.5});
        FiniteNode wind_tm1 = new FullCPTNode(Testing.WIND_tm1_RV,
                new double[]{0.5, 0.5});
        ...
        FiniteNode wind_t = new FullCPTNode(Testing.WIND_t_RV, new double[]{
                // W_t-1 = true, W_t = true
                0.7,
        ...
        X_0_to_X_1.put(Testing.WIND_tm1_RV, ExampleRV.RAIN_t_RV);
        X_0_to_X_1.put(Testing.WIND_tm1_RV, Testing.WIND_t_RV);
